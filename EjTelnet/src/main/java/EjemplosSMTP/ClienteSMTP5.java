...
public class ClienteSMTP5 {
	public static void main(String[] args) throws NoSuchAlgorithmException, UnrecoverableKeyException,
		...
		String username = "nombre@outlook.es";
		String password = "";
		int puerto = 465;
		String remitente = "nombre@outlook.es";
		*/
		String server = "smtp.gmail.com";
		String username = "nombre@gmail.com";
		String password = ""; //Habilitar el acceso en dos pasos y generar contraseña para aplicación
		int puerto = 465;
		String remitente = "nombre@gmail.com";
		...
		try {
			...
			if (client.auth(AuthenticatingSMTPClient.AUTH_METHOD.LOGIN, username, password)) {
				...
				String destino1 = "esthermorenoprofesora@gmail.com";
